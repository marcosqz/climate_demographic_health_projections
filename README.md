...
- Processes raw climate model projections to derive regional temperature time series and applies bias correction using the temperature observations used in the epidemiological analysis.
